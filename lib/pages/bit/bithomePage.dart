...
class _BitHomePageState extends State<BitHomePage>
  ...
  void initState() {
    super.initState();
    swiperList = [
      "assets/images/wallhaven-gp5gm3.jpg",
      "assets/images/wallhaven-m3zey9.jpg"
    ];
    itemList = [
      ItemModel("assets/images/wallhaven-jxw7ym.jpg", "草莓大丰收", "2月21日 准点开始"),
      ItemModel(
          "assets/images/wallhaven-gp5gpl.jpg", "1024程序员聚会", "来会场看看谁才是头秃body"),
      ItemModel("assets/images/wallhaven-2yzl89.jpg", "游戏攻略", "下午三点准时开始直播")
    ];
  ...
  late List<NewsModel> itemList1 = [
    NewsModel("标题党", "2023-10-10", 123, 456,
        imgUrl: "assets/images/wallhaven-2yzx89.jpg"),
    NewsModel("标题党", "2023-10-10", 123, 456,
        imgUrl: "assets/images/wallhaven-kxzg77.jpg"),
    NewsModel("标题党", "2023-10-10", 123, 456,
        imgUrl: "assets/images/wallhaven-rrgxdq.jpg")
  ];
  @override
