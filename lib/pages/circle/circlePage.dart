...
import 'package:bit_seven/model/circle/circleModel.dart';
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: StaggeredGrid.count(
                      ...
                      crossAxisSpacing: 4,
                      children: [
                        getupdownWidget1("公告", "assets/svg/speakerphone.svg"),
                        getupdownWidget1("收藏", "assets/svg/star.svg"),
                        getupdownWidget1("留言", "assets/svg/annotation.svg"),
                        getupdownWidget1("点赞", "assets/svg/thumb-up.svg")
                      ],
                    ),
                  ),
                  ...
                  ListView.separated(
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      return getItemX(circleModelList[index], () {
                        setState(() {
                          circleModelList[index].attention =
                              !circleModelList[index].attention;
                        });
                      });
                    },
                    itemCount: circleModelList.length,
